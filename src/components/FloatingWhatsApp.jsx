...
export default function FloatingWhatsApp() {
  ...
  return (
    <div className="floating-whatsapp-container">
      ...
      <a
        href={`${BUSINESS_CONFIG.whatsappBaseUrl}?text=${encodeURIComponent('Hello Vinayaga Agency, I want to inquire about wholesale medicine availability.')}`}
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Contact Vinayaga Agency on WhatsApp"
